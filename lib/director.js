 ...
 *
 * Deduplicated, because a division literally named "Coed" already says its
 * gender and "Coed · Coed" is what you get otherwise.
 */
export function scopeLabel(gender, className) {
  return [...new Set([genderLabel(gender), className].filter(Boolean))].join(" · ");
}
