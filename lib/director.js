...
export async function listPeople() {
  ...
  return {
    ...
    players: (players ?? [])
      ...
      .map((p) => ({
        ...p,
        // The PERSON's class — what they are rated. Not the division's, and
        // not what a manager typed on a form. JD, 2026-07-27: "each player
        // has the class."
        className: p.class_id ? (classBy.get(p.class_id) ?? null) : null,
